<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"C:\phpStudy\PHPTutorial\WWW\tp\public/../application/home\view\index\index.html";i:1575736363;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8" />
...
<header data-am-widget="header" class="am-header am-header-default sq-head ">
    ...
    <form action="<?php echo url('home/index/index'); ?>" method="post" id="storeForm">
    ...
    <div id="ingralBox">当前<a href="http://www.sixmeter.cn/home/Personal/index">积分</a>：<?php echo $integral; ?>，<span><a id="myorderfont" href="<?php echo url('home/order/myorder'); ?>"><u>我的订单</u></a></span></div>

</header>
<div class="list-left-my">
    <form id="orderform" action="<?php echo url('home/order/index'); ?>" method="post">
        <input type="hidden" id="chosenum" name="chosenum">
                ...
                <ul class="list-pro" style="height: <?php echo $vo['viewsize']; ?>" >
                    ...
                    <li>
                        <div>
                            <div class="selfPic">
                                <?php if($voo['status'] == '0'): ?>
                                <a><img  src="../../images/sytp.jpg" class="" /></a>
                                <?php else: ?>
                            ...
                            <div class="self-right-right">
                                <div>
                                    <p class="foodname" style="font-size: 20px;" ><?php echo $voo['name']; ?></p>
                                ...
                                <div class="listcart">
                                    <input type="hidden" class="iscid" value="<?php echo $voo['cid']; ?>">
                                    <div class="dstock ">
...
<script>
    function addorder() {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "<?php echo url('home/Index/checkChose'); ?>" ,
