<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:90:"C:\phpStudy\PHPTutorial\WWW\tp\public/../application/index\view\category\listcategory.html";i:1561703484;}*/ ?>
            ...
            <tr>
                ...
                <td>
                    <select style="width: 100%;margin: 0px;padding-top: 0px;padding-bottom: 0px;height: 28px;line-height: 28px;" name="prints" id="grade">
                        <option value=""></option>
                        <?php foreach($printsList as $key => $vo): ?> 
...
<script>
    ...
    function saveCategory() {
        saveData("<?php echo url('Index/Category/addCategory'); ?>","#addform","#win");
    }
    /*打开编辑窗口*/
