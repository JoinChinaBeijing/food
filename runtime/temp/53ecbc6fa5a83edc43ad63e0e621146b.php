<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"C:\phpStudy\PHPTutorial\WWW\tp\public/../application/home\view\order\index.html";i:1575738293;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div>
    ...
    <form action="<?php echo url('home/order/addorder'); ?>" method="post" id="addorder">
                    ...
                    <div id="adr" class="findlyadr<?php echo $defaultAdr['id']; ?>">
                        ...
                        <div class="adrbox">
                            <div class="adrdetailbox">
                                ...
                                <span class="fontmay">联系地址： <span class="fontmay" id="useraddress"><?php echo $defaultAdr['school']; ?><?php echo $defaultAdr['detail']; ?></span></span>
                            </div>
                        </div>
                    </div>
                    <div id="moreadropen">
                        ...
                        <div class="mynewaddress" >
                            ...
                            <div class="mycheckaddress">
                                <p class="newaddress fontmay">
                                    <span class="school"><?php echo $vo['school']; ?></span><span class="detail"><?php echo $vo['detail']; ?></span>
                                </p>
                                <div>
        ...
        <div id="deliverypricebox">
            <div id="deliveryprice" class="delivery">
                <div class="deliverytop">
                    ...
                    <input type="hidden" name="deliveryamount" id="deliveryamount" value="<?php echo $yunfei; ?>">
                </div>
            </div>
        </div>
    </div>
...
<div  id= "addbox">
    <div class="newAddressForm">
        <form id="adrForm" action="<?php echo url('home/Address/addAddress'); ?>" method="post">
...
<script>
    function insertAddress() {
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "<?php echo url('home/Address/addAddress'); ?>" ,
